...
class UpdateTaskUseCase:
    ...
    def execute(self, data: UpdateTaskDTO, current_user_id=None):
        ...
        def update():
            # Validate task owner before applying the update.
            ...
            # Validate task after applying changes.
            if not task.subject:
            ...
            # Convert relationship UUIDs into human-readable names.
            ...
            # Record timeline only when something actually changed.
            #
            # IMPORTANT:
            # A Task does not necessarily have a Lead, Contact, or Account.
            # Therefore timeline recording must NOT depend on targets being
